...
//! original from https://github.com/Lagrang/art-rs, with some bugfixes and improvements.
//!
//! # Examples
//! ```
//! use uzumibi_art_router::vendor_art_tree::ByteString;
//! use uzumibi_art_router::vendor_art_tree::KeyBuilder;
//! use uzumibi_art_router::vendor_art_tree::Art;
//!
...
use crate::vendor_art_tree::scanner::Scanner;
...
#[cfg(test)]
mod tests {
    use crate::vendor_art_tree::{Art, ByteString, Float32, Float64, KeyBuilder};
