...
const cargoArgs = [
    "build",
    "--package", "uzumibi-on-cloudflare-spike",
...
const source = join(
    projectDir,
    "../target/wasm32-unknown-unknown/release/uzumibi_on_cloudflare_spike.wasm",
);
const outputName = mode === "queue"
    ? "uzumibi_on_cloudflare_spike_queue.wasm"
    : "uzumibi_on_cloudflare_spike.wasm";
